...
Namespace DXGrid_DisplayTotals
	Partial Public Class Window1
		...
		Private Sub CreateTotalSummaries()
			grid.TotalSummary.Add(New GridSummaryItem() With {.FieldName = "UserName", _
				.SummaryType = SummaryItemType.Count, .DisplayFormat = "Total Users: {0}"})
			grid.TotalSummary.Add(New GridSummaryItem() With {.FieldName = "Age", _
